  ...
  Container = (function() {
    ...
    Container.prototype.getWithStack = function(id, stack, callback) {
      ...
      if (!(diConfig.inject != null)) {
        return this.handleAsync(this.instantiate(required, diConfig), diConfig, callback);
      }
      this.resolveInjection(diConfig.inject, stack, __bind(function() {
        var services;
        services = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        return this.handleAsync(this.instantiate.apply(this, [required, diConfig].concat(__slice.call(services))), diConfig, callback);
      }, this));
      return;
    };
    ...
    Container.prototype.handleAsync = function(service, diConfig, parentCallback) {
